    ...
    <section id="experience" style={{ padding: '5.5rem 0' }}>
      <div className="container">
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: '1.2rem', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.6rem', color: '#f59e0b' }}>
              <Briefcase size={20} />
              <span>Work & University R&D Research Experience</span>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
              {experiences.map((exp, idx) => (
                <div key={idx} className="glass-card" style={{ padding: '1.75rem', position: 'relative' }}>
                  ...
                  <div style={{ fontSize: '0.95rem', fontWeight: 600, color: '#06b6d4', marginBottom: '1rem' }}>
                  ...
                  <ul style={{ listStyle: 'none', padding: 0, marginBottom: '1.25rem' }}>
                    {exp.description.map((item, i) => (
                      <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.6rem', marginBottom: '0.6rem', fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
          ...
          <div>
            ...
            <div style={{ marginBottom: '2rem' }}>
              <div style={{ fontWeight: 700, fontSize: '1.2rem', marginBottom: '1.2rem', display: 'flex', alignItems: 'center', gap: '0.6rem', color: '#06b6d4' }}>
              ...
              <div className="glass-card" style={{ padding: '1.5rem' }}>
                ...
                <div style={{ color: '#f59e0b', fontWeight: 600, fontSize: '0.9rem', marginBottom: '0.6rem' }}>
            ...
            <div style={{ marginBottom: '2rem' }}>
              <div style={{ fontWeight: 700, fontSize: '1.2rem', marginBottom: '1.2rem', display: 'flex', alignItems: 'center', gap: '0.6rem', color: '#f59e0b' }}>
                <Users size={20} />
                  ...
                  {leadership.map((l, idx) => (
                    <div key={idx} style={{
                      ...
                      <div style={{ fontWeight: 700, fontSize: '0.9rem', color: '#f8fafc' }}>
                        {l.role} <span style={{ color: '#06b6d4', fontWeight: 400 }}>— {l.org}</span>
                      </div>
            ...
            {/* Certifications Box */}
            <div>
              <div style={{ fontWeight: 700, fontSize: '1.2rem', marginBottom: '1.2rem', display: 'flex', alignItems: 'center', gap: '0.6rem', color: '#10b981' }}>
                <Award size={20} />
